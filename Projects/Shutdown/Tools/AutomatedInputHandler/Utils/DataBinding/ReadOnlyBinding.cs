...
namespace Utils.DataBinding {
    public class ReadOnlyBinding : FreezableBinding {
        public ReadOnlyBinding() { Mode = BindingMode.OneWayToSource; }
        ...
        #region Properties
        public object TargetPropertyMirror { get { return GetValue(TargetPropertyMirrorProperty); } set { SetValue(TargetPropertyMirrorProperty, value); } }
        public object TargetPropertyListener { get { return GetValue(TargetPropertyListenerProperty); } set { SetValue(TargetPropertyListenerProperty, value); } }
