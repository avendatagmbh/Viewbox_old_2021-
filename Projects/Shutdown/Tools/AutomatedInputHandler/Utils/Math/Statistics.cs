...
namespace Utils.Math {
    public static class Statistics {
        ...
        /// <param name="length">The length of the combination.</param>
        /// <returns></returns>
        public static int GetCombinationCount(int n, int length) { return BinomialCoefficient(n, length); }
        ...
        /// <param name="n">The number of elements.</param>
        /// <returns></returns>
        public static int GetPermutationCount(int n) { return Factorial(n); }
