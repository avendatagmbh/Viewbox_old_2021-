...
namespace DbSearchBase {
    ...
    public class Permutations : CombinatorialBase {
        ...
        public Permutations(System.Collections.IList listObjects)
            : base(listObjects, listObjects.Count) {
        }

        public Permutations(System.Collections.IEnumerator enumeratorObjects)
            : base(enumeratorObjects, 1) {

        }

        public Permutations(Array arrayObjects, int nKlass)
            : base(arrayObjects, nKlass) {
        }

        public Permutations(System.Collections.IList listObjects, int nKlass)
            : base(listObjects, nKlass) {
        }

        public Permutations(System.Collections.IEnumerator enumeratorObjects, int nKlass)
