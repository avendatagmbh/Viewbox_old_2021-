...
namespace ViewBuilderCommon
{
    ...
    {
        public ReportParameter(string databaseName, string tableName, string columnName, string parameterName,
                               SqlType type, string defaultValue, int typeModifier)
        {
        ...
        {
            if (ParameterDescription.Count == 0) return ParameterName;
