CREATE DEFINER=`root`@`localhost` PROCEDURE `GenerateRowNoInfo`(IN InColumnId INT(11))
BEGIN
	...
	OPEN cur0;
		loop0: LOOP
			...
			END IF;
						...
						BLOCK1: BEGIN
							DECLARE old_value_id INT(11);
							DECLARE start_rowno INT(11);
							DECLARE old_rowno INT(11);
