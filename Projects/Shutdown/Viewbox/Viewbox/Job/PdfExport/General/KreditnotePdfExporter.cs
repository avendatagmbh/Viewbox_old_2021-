...
{
	public class KreditnotePdfExporter : IPdfExporter
	{
		...
		public void Export()
		{
			...
			KreditnotePdfLayout layout = new KreditnotePdfLayout();
		...
		private void FillUpLayout(KreditnotePdfLayout layout, DataTable dataTable)
		{
		...
		protected virtual void CustomizeLayout(KreditnotePdfLayout layout)
		{
		}
	}
}
