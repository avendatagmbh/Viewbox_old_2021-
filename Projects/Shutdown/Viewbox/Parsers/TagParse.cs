...
namespace Parsers
{
    ...
    public abstract class TagBase
    {
        ...
        public static string GetTagType(Type tag)
        {
            ...
            var tagTypeAttribute = myTagTypeAttributes[0] as TagTypeAttribute;
            return (tagTypeAttribute == null) ? null : tagTypeAttribute.Type;
        }
        ...
        /// </summary>
        /// <returns>
        /// If this value is less than zero, then there is no ending; otherwise the position after ending is returned.
        /// </returns>
