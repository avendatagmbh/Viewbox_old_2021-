...
namespace eBalanceKitBusiness.Test
{
    ...
    /// <summary>
    ///This is a test class for SearchResultItemTest and is intended
    ///to contain all SearchResultItemTest Unit Tests
    ///</summary>
    [TestClass()]
    public class SearchResultItemTest {
        ...
        public void ToString_EmptyList() {
            SearchResultItem target = new SearchResultItem {PresentationTreeEntryPath = new List<ISearchableNode>()};
