...
namespace eBalanceKit.Windows.Security {
    ...
    public partial class CtlEditUser : UserControl {
        ...
        private void UserControl_KeyDown(object sender, KeyEventArgs e) { if (e.Key == Key.Escape) { e.Handled = true; OnCancel(); } }
        ...
        //    if (Model.SelectedUser == null || !Model.SelectedUser.IsDomainUser) return;
