...
namespace DataAnalyze.Model {
    ...
    public class MatrixBase<T> {
        ...
        public virtual MatrixBase<T> Clone() { return new MatrixBase<T>(this); }
        ...
        public virtual void CopyInto(MatrixBase<T> targetMatrix) { CopyInto(targetMatrix, 0, 0); }
        ...
        public virtual void CopyInto(
            ...
            Int32 targetRowOffset) { ElementWiseCopy(this, targetMatrix, targetColumnOffset, targetRowOffset); }
        ...
        public virtual void CopyFrom(MatrixBase<T> sourceMatrix) { CopyFrom(sourceMatrix, 0, 0); }
        ...
        public virtual void CopyFrom(
            ...
            Int32 targetColumnOffset,
            Int32 targetRowOffset) { ElementWiseCopy(sourceMatrix, this, targetColumnOffset, targetRowOffset); }
        ...
        public override Boolean Equals(Object obj) { return Equality(this, obj as MatrixBase<T>); }
        ...
        public virtual MatrixBase<T> SubMatrix(
            ...
            Int32Range rowRange) { return SubMatrix(this, columnRange, rowRange); }
        ...
        public virtual void SwapColumns(Int32 column1, Int32 column2) { SwapColumns(this, column1, column2); }
        ...
        public virtual void SwapRows(Int32 row1, Int32 row2) { SwapRows(this, row1, row2); }

        /// <summary>
        /// Gets the row data.
        /// </summary>
        /// <param name="rowID">The row ID.</param>
        /// <returns>Generic list of row data</returns>
        public virtual List<T> GetRow(int rowID) {
            var _datas = new List<T>();
            int columnCount = ColumnCount;

            for (int i = 0; i < columnCount; i++) {
                _datas.Add(this[i, rowID]);
            }
        ...
        public override String ToString() {
            ...
            for (Int32 j = 0; j < RowCount; j++) {
                ...
                for (Int32 i = 0; i < ColumnCount; i++) {
                    if (this[i, j] != null) {
                        rowStr += String.Format(" {0} ", this[i, j]);
                    }
                }
        ...
        public static MatrixBase<T> Default(Int32 columns, Int32 rows) {
            var defaultMatrix = new MatrixBase<T>(columns, rows);
        ...
        public static MatrixBase<T> ElementWiseOperation(
            ...
            if (matrix1.ColumnCount != matrix2.ColumnCount) {
                throw new DimensionMismatchException(
                    "The number of columns in matrix1 does not equal the number of columns in matrix2");
            }
            if (matrix1.RowCount != matrix2.RowCount) {
                throw new DimensionMismatchException(
                    "The number of rows in matrix1 does not equal the number of rows in matrix2");
            }

            var result = new MatrixBase<T>(matrix1.ColumnCount, matrix1.RowCount);
        ...
        public static MatrixBase<T> ElementWiseOperation(
            ...
            var result = new MatrixBase<T>(matrix.ColumnCount, matrix.RowCount);
            for (Int32 i = 0; i < result.ColumnCount; i++) {
                for (Int32 j = 0; j < result.RowCount; j++) {
        ...
        public static Boolean IsNull(MatrixBase<T> matrix) { return ((object) matrix == null); }
        ...
        public static Boolean IsNullOrEmpty(MatrixBase<T> matrix) { return ((object) matrix == null) || matrix.IsEmpty; }
        ...
        public static MatrixBase<T> JoinHorizontal(
            ...
            var resultMatrix = new MatrixBase<T>(totalColumnCount, (int) rowCount);

            int columnOffset = 0;
            foreach (var matrix in matricies) {
                ElementWiseCopy(matrix, resultMatrix, columnOffset, 0);
        ...
        public static MatrixBase<T> JoinHorizontal(
            ...
            MatrixBase<T> rightMatrix) { return JoinHorizontal(new[] {leftMatrix, rightMatrix}); }
        ...
        public static MatrixBase<T> JoinVertical(
            ...
            var resultMatrix = new MatrixBase<T>((int) columnCount, totalRowCount);

            int rowOffset = 0;
            foreach (var matrix in matricies) {
                ElementWiseCopy(matrix, resultMatrix, 0, rowOffset);
        ...
        public static MatrixBase<T> JoinVertical(
            ...
            MatrixBase<T> bottomMatrix) { return JoinVertical(new[] {topMatrix, bottomMatrix}); }
        ...
        /// <returns></returns>
        public static Boolean operator ==(MatrixBase<T> matrix1, MatrixBase<T> matrix2) { return Equality(matrix1, matrix2); }
        ...
        public static implicit operator MatrixBase<T>(T[,] dataArray) { return new MatrixBase<T>(dataArray); }
        #endregion Public Implicit Operators

        private readonly Int32Range _dataColumnRange;
        private readonly Int32Range _dataRowRange;
        private readonly MatrixDataSource<T> _dataSource;
        ...
        public MatrixBase(MatrixBase<T> matrix)
            : this(matrix.ColumnCount, matrix.RowCount) { CopyFrom(matrix); }
        ...
        public virtual MatrixBase<T> Copy { get { return Clone(); } }
        ...
        /// </summary>
        public virtual Boolean IsScalar { get { return RowCount == 1 && ColumnCount == 1; } }

        /// <summary>Indicates whether this is a square matrix</summary>
        public virtual Boolean IsSquare { get { return RowCount == ColumnCount; } }
        ...
        /// </summary>
        public virtual Boolean IsVector { get { return IsRowVector || IsColumnVector; } }
        ...
        public virtual MatrixBase<T> Transposed { get { return Transpose(this); } }
        #endregion Public Getters / Setters

        #region Nested type: ColumnAccessor
        public class ColumnAccessor<T>
            : IEnumerable<MatrixBase<T>> {
            /*******************/
            /* PRIVATE MEMBERS */
            /*******************/
            private readonly MatrixBase<T> _dataView;
            ...
            public ColumnAccessor(MatrixBase<T> dataView) { _dataView = dataView; }
            ...
            public MatrixBase<T> this[Int32 columnIndex] {
                get { return AsEnumerable().ElementAt(columnIndex); }
                set {
                    if (value.RowCount != _dataView.RowCount || value.ColumnCount != 1) {
                        throw new DimensionMismatchException();
                    }

                    MatrixBase<T> targetColumn = AsEnumerable().ElementAt(columnIndex);
            ...
            /// <returns></returns>
            public IEnumerator<MatrixBase<T>> GetEnumerator() { return AsEnumerable().GetEnumerator(); }
        ...
        #region Nested type: RowAccessor
        public class RowAccessor<T>
            ...
            /// <param name="dataView"></param>
            public RowAccessor(MatrixBase<T> dataView) { _dataView = dataView; }
            #endregion Public Constructor
            ...
            public MatrixBase<T> this[Int32 rowIndex] {
                get { return AsEnumerable().ElementAt(rowIndex); }
                set {
                    if (value.ColumnCount != _dataView.ColumnCount || value.RowCount != 1) {
                        throw new DimensionMismatchException();
                    }

                    MatrixBase<T> targetRow = AsEnumerable().ElementAt(rowIndex);
