...
(function($) {
    ...
    var init = function(tb, options) {
        ...
        t.c = [];
        t.w = t.width();
        t.gc = t.prev(); //t.c and t.g are arrays of columns and grips respectively				
    ...
    var createGrips = function(t) {
        /*MODIFIED for VIEWBOX datagrid, last column is invisible: t.ln = th.length - 1 added instead of t.ln = th.length */
        ...
        t.ln = th.length - 1; //table length is stored	
...
//height and position of the grip is updated according to the table layout
	...
	*/
    ...
    var onGripMouseDown = function(e) {
        ...
        g.ox = e.pageX;
        g.l = g.position().left; //the initial position is kept				
