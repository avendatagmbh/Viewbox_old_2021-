...
(function(a) {
    var A = function(s, v) {
        ...
        var l =
            0;
        if (!f.manualAdvance && j.length > 1) l = setInterval(function() { r(e, j, f, false); }, f.pauseTime);
        if (f.directionNav) {
            ...
            if (f.directionNavHide) {
                ...
                e.hover(function() { a(".nivo-directionNav", e).show(); }, function() { a(".nivo-directionNav", e).hide(); });
            }
        ...
        f.pauseOnHover && e.hover(function() {
            ...
            g.paused = false;
            if (l == "" && !f.manualAdvance) l = setInterval(function() { r(e, j, f, false); }, f.pauseTime);
        });
        e.bind("nivo:animFinished", function() {
            g.running = false;
            a(j).each(function() { a(this).is("a") && a(this).css("display", "none"); });
            a(j[g.currentSlide]).is("a") &&
                a(j[g.currentSlide]).css("display", "block");
            if (l == "" && !g.paused && !f.manualAdvance) l = setInterval(function() { r(e, j, f, false); }, f.pauseTime);
        ...
        var w = function(b, h) {
            ...
            if (c.effect == "sliceDown" || c.effect == "sliceDownRight" || d.randAnim == "sliceDownRight" || c.effect == "sliceDownLeft" || d.randAnim == "sliceDownLeft") {
                ...
                h.each(function() {
                    var i = a(this);
                    i.css({ top: "0px" });
                    m == c.slices - 1 ? setTimeout(function() { i.animate({ height: "100%", opacity: "1.0" }, c.animSpeed, "", function() { b.trigger("nivo:animFinished"); }); },
                        100 + n) : setTimeout(function() { i.animate({ height: "100%", opacity: "1.0" }, c.animSpeed); }, 100 + n);
                    n += 50;
                    m++;
                });
                ...
                h.each(function() {
                    ...
                    x == c.slices - 1 ? setTimeout(function() { i.animate({ height: "100%", opacity: "1.0" }, c.animSpeed, "", function() { b.trigger("nivo:animFinished"); }); }, 100 + n) : setTimeout(function() { i.animate({ height: "100%", opacity: "1.0" }, c.animSpeed); }, 100 + n);
                    n += 50;
                    x++;
                });
                ...
                a(".nivo-slice", b).each(function() {
                    ...
                    m == c.slices - 1 ? setTimeout(function() { i.animate({ width: y, opacity: "1.0" }, c.animSpeed, "", function() { b.trigger("nivo:animFinished"); }); },
                        100 + n) : setTimeout(function() { i.animate({ width: y, opacity: "1.0" }, c.animSpeed); }, 100 + n);
                    n += 50;
                    m++;
                });
                ...
                q.animate({ opacity: "1.0" }, c.animSpeed * 2, "", function() { b.trigger("nivo:animFinished"); });
            } else if (c.effect == "slideInRight" || d.randAnim == "slideInRight") {
                q = a(".nivo-slice:first", b);
                q.css({ height: "100%", width: "0px", opacity: "1" });
                q.animate({ width: b.width() + "px" }, c.animSpeed * 2, "", function() { b.trigger("nivo:animFinished"); });
            } else if (c.effect ==
        ...
        }, z = function(b) { this.console && typeof console.log != "undefined" && console.log(b); };
        this.stop = function() {
