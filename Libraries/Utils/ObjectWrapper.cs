...
{
    /// <summary>
    ///   Wrapper class - used if a specific object is needed in many controls to provide property changed events without the necessity to update each control manually.
    /// </summary>
