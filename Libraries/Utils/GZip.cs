...
namespace Utils
{
    public static class GZip
    {
        ...
        public static void Compress(string filename, string destFilename = null)
        {
            Compress(new FileInfo(filename), destFilename);
        }
        ...
        public static void Decompress(string filename, string destFilename = null)
        {
            Decompress(new FileInfo(filename), destFilename);
        }
