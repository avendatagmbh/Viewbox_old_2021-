...
namespace Utils
{
    ...
    public sealed class SynchronizationCallback
    {
        ...
        /// <summary>
        ///   Creates an instance of a <see cref="SynchronizationCallback" /> using the default <see cref="SynchronizationContext" /> and a callback that accepts the <see
        ///    cref="SynchronizationContext" /> and a user object as arguments.
        /// </summary>
        /// <param name="callback"> The delegate to invoke. </param>
        ...
        /// <summary>
        ///   Creates an instance of a <see cref="SynchronizationCallback" /> using a specified <see cref="SynchronizationContext" /> and a callback that accepts the <see
        ///    cref="SynchronizationContext" /> and a user object as arguments.
        /// </summary>
        /// <param name="callback"> The delegate to invoke. </param>
        /// <param name="context"> The synchronization context to set while invoking the delegate. </param>
        ...
        /// </summary>
        /// <value> The <see cref="Delegate" /> that is associated with this callback. </value>
        private Delegate Callback { get; set; }

        /// <summary>
        ///   Gets the number of parameters in <see cref="Callback" /> .
        /// </summary>
        private int CallbackParameters { get; set; }

        /// <summary>
        ///   Gets the synchronization context that is set while invoking <see cref="Callback" /> .
        /// </summary>
        /// <value> The <see cref="SynchronizationContext" /> associated with this callback. </value>
        ...
        /// <summary>
        ///   Wraps a <see cref="WaitCallback" /> in a <see cref="SynchronizationCallback" /> using the default <see
        ...
        /// <summary>
        ///   Wraps a <see cref="TimerCallback" /> in a <see cref="SynchronizationCallback" /> using the default <see
        ///    cref="SynchronizationContext" /> .
        /// </summary>
        /// <param name="callback"> The callback to wrap. </param>
        /// <returns> A <see cref="SynchronizationCallback" /> that wraps <paramref name="callback" /> . </returns>
        ...
        /// <summary>
        ///   Wraps a <see cref="SendOrPostCallback" /> in a <see cref="SynchronizationCallback" /> using the default <see
        ///    cref="SynchronizationContext" /> .
        /// </summary>
        /// <param name="callback"> The callback to wrap. </param>
        /// <returns> A <see cref="SynchronizationCallback" /> that wraps <paramref name="callback" /> . </returns>
        ...
        /// <summary>
        ///   Wraps a <see cref="ThreadStart" /> routine in a <see cref="SynchronizationCallback" /> using the default <see
        ///    cref="SynchronizationContext" /> .
        /// </summary>
        /// <param name="callback"> The callback to wrap. </param>
        /// <returns> A <see cref="SynchronizationCallback" /> that wraps <paramref name="callback" /> . </returns>
        ...
        /// <summary>
        ///   Wraps a <see cref="ParameterizedThreadStart" /> routine in a <see cref="SynchronizationCallback" /> using the default <see
        ///    cref="SynchronizationContext" /> .
        /// </summary>
        /// <param name="callback"> The callback to wrap. </param>
        /// <returns> A <see cref="SynchronizationCallback" /> that wraps <paramref name="callback" /> . </returns>
        ...
        /// <summary>
        ///   Wraps an <see cref="Action" /> in a <see cref="SynchronizationCallback" /> using the default <see
        ///    cref="SynchronizationContext" /> .
        /// </summary>
        /// <param name="callback"> The callback to wrap. </param>
        /// <returns> A <see cref="SynchronizationCallback" /> that wraps <paramref name="callback" /> . </returns>
