...
{
    /// <summary>
    ///   Common UI relC:\Users\beh\Documents\Visual Studio 2010\Projects\vs2010\Libraries\Utils\UIHelpers.csated helper methods.
    /// </summary>
    public static class UIHelpers
    {
        ...
        /// <summary>
        ///   This method is an alternative to WPF's <see cref="VisualTreeHelper.GetParent" /> method, which also supports content elements. Do note, that for content element, this method falls back to the logical tree of the element.
        /// </summary>
        ...
        /// <param name="properties"> The properties to be updated if <paramref name="obj" /> or one of its childs provide it along with a binding expression. </param>
        ...
        public static T FindVisualChild<T>(DependencyObject parent) where T : DependencyObject
        {
            for (int i = 0; i < VisualTreeHelper.GetChildrenCount(parent);)
            {
                ...
                if (child == null) return null;
                else if (child is T) return (T) child;
                else return FindVisualChild<T>(child);
            }
            return null;
        }
