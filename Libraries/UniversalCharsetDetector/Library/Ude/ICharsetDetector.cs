...
namespace Ude
{
    public interface ICharsetDetector
    {
        ...
        /// <param name="maxLength"> maximum number of available bytes </param>
        void Feed(Stream stream, int maxLength);
        ...
        /// <summary>
        ///   Tell the detector that there is no more data and it must take its decision.
        /// </summary>
        void DataEnd();
    }
}