...
namespace AvdWpfControls.Utils
{
    public class NumericBehavior
    {
        ...
        private static void OnAcceptOnlyNumericsPropertyChanged(DependencyObject sender,
        ...
        private static void OnPreviewKeyDown(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.D0 || e.Key == Key.D1 || e.Key == Key.D2 || e.Key == Key.D3 ||
                ...
                e.Key == Key.NumPad8 || e.Key == Key.NumPad9 || e.Key == Key.OemPeriod || e.Key == Key.OemComma ||
                e.Key == Key.Separator ||
                ...
                e.Key == Key.F1 || e.Key == Key.F2 || e.Key == Key.F3 || e.Key == Key.F4 || e.Key == Key.F5 ||
                e.Key == Key.F6 || e.Key == Key.F7 || e.Key == Key.F8 || e.Key == Key.F9 || e.Key == Key.F10 ||
                e.Key == Key.F11 || e.Key == Key.F12 ||
